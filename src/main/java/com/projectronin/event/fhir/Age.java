...
public class Age {
    ...
    private Age.Comparator comparator;
    /**
     * Base definition for all elements in a resource.
     * 
     */
     ...
     */
    @JsonProperty("comparator")
    public Age.Comparator getComparator() {
        return comparator;
    }
     ...
     */
    @JsonProperty("comparator")
    public void setComparator(Age.Comparator comparator) {
    ...
    public String toString() {
        ...
        sb.append(Age.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public enum Comparator {
        ...
        private final static Map<String, Age.Comparator> CONSTANTS = new HashMap<String, Age.Comparator>();

        static {
            for (Age.Comparator c: values()) {
        ...
        @JsonCreator
        public static Age.Comparator fromValue(String value) {
            Age.Comparator constant = CONSTANTS.get(value);
            if (constant == null) {
