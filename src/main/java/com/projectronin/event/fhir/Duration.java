...
public class Duration {
    ...
    private Duration.Comparator comparator;
    /**
     * Base definition for all elements in a resource.
     * 
     */
     ...
     */
    @JsonProperty("comparator")
    public Duration.Comparator getComparator() {
        return comparator;
    }
     ...
     */
    @JsonProperty("comparator")
    public void setComparator(Duration.Comparator comparator) {
    ...
    public enum Comparator {
        ...
        private final static Map<String, Duration.Comparator> CONSTANTS = new HashMap<String, Duration.Comparator>();

        static {
            for (Duration.Comparator c: values()) {
        ...
        @JsonCreator
        public static Duration.Comparator fromValue(String value) {
            Duration.Comparator constant = CONSTANTS.get(value);
            if (constant == null) {
