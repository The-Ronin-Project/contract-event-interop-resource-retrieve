...
public class Timing {
     ...
     */
    @JsonProperty("event")
    @JsonPropertyDescription("Identifies specific times when the event occurs.")
     ...
     */
    @JsonProperty("_event")
    @JsonPropertyDescription("Extensions for event")
    private List<Element> _event = new ArrayList<Element>();
    /**
     * Specifies an event that may occur multiple times. Timing schedules are used to record when things are planned, expected or requested to occur. The most common usage is in dosage instructions for medications. They are also used when planning care of various kinds, and may be used for reporting the schedule to which past regular activities were carried out.
     * 
     */
     ...
     */
    @JsonProperty("_event")
    public void set_event(List<Element> _event) {
        this._event = _event;
    }
     ...
     */
    @JsonProperty("repeat")
    public Timing_Repeat getRepeat() {
        return repeat;
    }
     ...
     */
    @JsonProperty("repeat")
    public void setRepeat(Timing_Repeat repeat) {
        this.repeat = repeat;
    }
    ...
    public String toString() {
        ...
        sb.append("_event");
        sb.append('=');
        sb.append(((this._event == null)?"<null>":this._event));
        sb.append(',');
        sb.append("repeat");
        sb.append('=');
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this._event == null)? 0 :this._event.hashCode()));
    ...
    public boolean equals(Object other) {
        ...
        return ((((((((this.extension == rhs.extension)||((this.extension!= null)&&this.extension.equals(rhs.extension)))&&((this.code == rhs.code)||((this.code!= null)&&this.code.equals(rhs.code))))&&((this.modifierExtension == rhs.modifierExtension)||((this.modifierExtension!= null)&&this.modifierExtension.equals(rhs.modifierExtension))))&&((this.repeat == rhs.repeat)||((this.repeat!= null)&&this.repeat.equals(rhs.repeat))))&&((this._event == rhs._event)||((this._event!= null)&&this._event.equals(rhs._event))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.event == rhs.event)||((this.event!= null)&&this.event.equals(rhs.event))));
    }
