...
public class Count {
    ...
    private Count.Comparator comparator;
    /**
     * Base definition for all elements in a resource.
     * 
     */
     ...
     */
    @JsonProperty("comparator")
    public Count.Comparator getComparator() {
        return comparator;
    }
     ...
     */
    @JsonProperty("comparator")
    public void setComparator(Count.Comparator comparator) {
    ...
    public enum Comparator {
        ...
        private final static Map<String, Count.Comparator> CONSTANTS = new HashMap<String, Count.Comparator>();

        static {
            for (Count.Comparator c: values()) {
        ...
        @JsonCreator
        public static Count.Comparator fromValue(String value) {
            Count.Comparator constant = CONSTANTS.get(value);
            if (constant == null) {
